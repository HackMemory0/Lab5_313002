...
import ru.ifmo.lab.exceptions.ExecutionException;
...
public class ConsoleManager {
    ...
    public City getCity(){
        ...
        return new City(-1L, name, coord, LocalDate.now(), area, population, metersAboveSeaLevel, timezone, capital, government, human, -1, "default");
    }
