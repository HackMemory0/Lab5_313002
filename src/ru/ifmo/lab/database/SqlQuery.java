...
public class SqlQuery {
    public static class Get {
        //City
        public static final String CITY = "SELECT city.id, city.name, coordinates.x, coordinates.y, city.creation_date, city.area, city.population, city.meters_above_sea_level, city.timezone, city.capital, city.goverment, city_human.age, city.user_id, city.username\n" +
                "FROM city\n" +
    ...
    public static class Add {
        ...
        public static final String CITY = "" +
                "INSERT INTO city(name, creation_date, area, population, meters_above_sea_level, timezone, capital, goverment, user_id, username)\n"+
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING id";
    ...
    public static class Update {
        public static final String CITY = "" +
        "UPDATE city SET name=?, creation_date=?, area=?, population=?, meters_above_sea_level=?, timezone=?, capital=?, goverment=?, user_id=?, username=? \n"+
                "WHERE city.id = ?;";
        public static final String COORDINATE = "" +
