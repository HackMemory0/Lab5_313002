...
//                    outObj = new CommandExecutionPacket(messageType, retObj);
//                }else if(retObj != null){
//                    outObj = new CommandExecutionPacket(messageType, retObj);
//                }else {
//                    outObj = new CommandExecutionPacket(messageType, new String(outputStream.toByteArray()));
//                }
//
//
//            }catch (InvalidValueException ex){
//                outObj = new CommandExecutionPacket(messageType, ex.getMessage());
//            }
